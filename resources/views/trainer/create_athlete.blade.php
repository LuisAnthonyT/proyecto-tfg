                    ...
                    <form action="{{ route('create-athlete' , $trainerId) }}" method="POST">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="objetive" id="objetive"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="days_available_week"
                                    ...
                                    semana</label>
                                <input type="number" min="0" name="days_available_week" id="days_available_week"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                        ...
                        <div class="p-6 border-t border-gray-200 rounded-b flex justify-center">
                            <button
