...
<div id="delete-session-modal{{$session->id}}" tabindex="-1" aria-hidden="true" role="dialog"
            ...
            <div class="m-4 my-10 max-w-[400px] mx-auto">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="flex items-center">
                        <button data-modal-hide="delete-session-modal{{$session->id}}" class="inline-flex items-center text-gray-900">
                ...
                <div class="mt-4 flex justify-center">
                    <form action="{{ route('session.destroy', $session)}}" method="post">
                        @csrf
                        @method('delete')
                        <button id="deletesession" type="submit"
                    ...
                    <button data-modal-hide="delete-session-modal{{$session->id}}" type="button"
