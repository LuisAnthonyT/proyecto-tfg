...
<div id="delete-workout-modal{{$workout->id}}" tabindex="-1" aria-hidden="true" role="dialog"
            ...
            <div class="m-4 my-10 max-w-[400px] mx-auto">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="flex items-center">
                        <button data-modal-hide="delete-workout-modal{{$workout->id}}" class="inline-flex items-center text-gray-900">
                ...
                <div class="mt-4 flex justify-center">
                    <form action="{{ route('workout.destroy', $workout->id)}}" method="post">
                        @csrf
                        @method('delete')
                        <button id="deleteworkout" type="submit"
                    ...
                    <button data-modal-hide="delete-workout-modal{{$workout->id}}" type="button"
