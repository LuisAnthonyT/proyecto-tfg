<!-- Modal component -->
<div id="add-register" tabindex="-1" aria-hidden="true"
            ...
            <div class="m-4 my-10 max-w-[400px] mx-auto">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="flex items-center">
                        <button data-modal-hide="add-register" class="inline-flex items-center text-gray-900">
                ...
                <form action="{{ route('register.store')}}" method="POST">
                    ...
                    <div class="grid grid-cols-3 gap-2">
                        <div class=" my-2 col-span-3 sm:col-span-3">
                            <label for="weigth" class="text-sm font-medium text-gray-900 block mb-2">Peso</label>
                            <input type="number" step="0.01" autofocus id="weigth" name="weigth"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                placeholder="Peso corporal"/>
                        </div>
                    </div>
                    <div class="mt-4 flex justify-center">
                        <button id="addRegister" type="submit"
                        ...
                        <button data-modal-hide="add-register" type="button"
