...
<div id="modify-nutrition-modal{{$register->id}}" tabindex="-1" aria-hidden="true"
            ...
            <div class="m-4 my-10 max-w-[400px] mx-auto">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="flex items-center">
                        <button data-modal-hide="modify-nutrition-modal{{$register->id}}" class="inline-flex items-center text-gray-900">
                ...
                <form action="{{ route('nutrition.update', $register)}}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-4 flex justify-center">
                        ...
                        <button data-modal-hide="modify-nutrition-modal{{$register->id}}" type="button"
