...
<div class="p-4 sm:ml-64">
    <div class="flex items-center justify-between mb-3">
        ...
        <div class="flex items-center">
            <button data-modal-target="add-register" data-modal-toggle="add-register"
                ...
                <tbody>
                    @foreach ($registers as $register)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                    <button data-modal-target="modify-register-modal{{$register->id}}"
                                        data-modal-toggle="modify-register-modal{{$register->id}}" type="button"
                                        class="px-3 font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                        Modificar
                                    </button>
                                    <button data-modal-target="delete-register-modal{{$register->id}}"
                                        data-modal-toggle="delete-register-modal{{$register->id}}" type="button"
...
@include('modals.register.add_register')
@include('modals.register.delete_register')
@include('modals.register.modify_register')
