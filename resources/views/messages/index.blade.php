        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div
                ...
                <div class="flex items-center justify-between mb-4">
                    <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white">Mensajes</h5>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="inline-flex items-center">
                                        <form action="{{ route('messages.destroy', $message)}}" method="post">
                                            @csrf
                                            @method('delete')
                                            <input class=" mt-3 mr-4 px-3 py-2 text-sm font-medium text-center inline-flex items-center text-white bg-red-600 rounded-lg hover:bg-red-700" type="submit" value="Eliminar">
                                        </form>
                                    </div>
                                </div>
                                </li>
